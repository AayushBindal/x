...
function draw(){ 
    ...
    text("press space bar to get second chance", (windowWidth/2-500)+250, windowHeight-50);
    text("when you have destroyed all the boxes press any other key than space bar to display all the box once again", windowWidth/2-500, height/2+300);
